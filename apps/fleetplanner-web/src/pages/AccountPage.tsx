  ...
  return (
    <div data-testid="account-page" style={{ width: "100%" }}>
      ...
      <section style={card}>
        ...
        <a href="/fleetplanner/auth/discord/link/start" data-testid="link-discord" style={{ marginTop: "0.9rem", display: "inline-flex", alignItems: "center", gap: 7, padding: "0.5rem 1.1rem", border: "1px solid rgba(88,101,242,0.5)", background: "rgba(88,101,242,0.12)", color: "var(--purple)", fontFamily: MONO, fontSize: "0.72rem", borderRadius: 9, textDecoration: "none" }}>
