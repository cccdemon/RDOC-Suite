...
const PROVIDERS: Array<{ key: string; labelKey: string; border: string; bg: string; color: string; icon: React.ReactNode }> = [
  ...
  {
    key: "github", labelKey: "login.github", border: "var(--wash)", bg: "var(--wash)", color: "var(--text)",
  ...
  {
    key: "google", labelKey: "login.google", border: "var(--wash)", bg: "var(--wash)", color: "var(--text)",
