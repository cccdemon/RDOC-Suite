...
const PROVIDERS: Array<{ key: string; label: string; border: string; bg: string; color: string; icon: React.ReactNode }> = [
  {
    key: "discord", label: "Mit Discord anmelden", border: "rgba(88,101,242,0.5)", bg: "rgba(88,101,242,0.14)", color: "#c2c8fb",
  ...
  {
    key: "github", label: "Mit GitHub anmelden", border: "rgba(255,255,255,0.16)", bg: "rgba(255,255,255,0.04)", color: "#ccdde8",
  ...
  {
    key: "google", label: "Mit Google anmelden", border: "rgba(255,255,255,0.16)", bg: "rgba(255,255,255,0.04)", color: "#ccdde8",
...
export function LoginPage() {
  ...
  return (
    <div data-testid="login-page" style={{ maxWidth: 420, margin: "3rem auto", textAlign: "center" }}>
      ...
      <p style={{ color: "#9fb1c2", fontSize: "0.9rem", margin: "0 0 1.6rem", lineHeight: 1.6 }}>Melde dich an, um Operationen zu planen, Sitze zu beanspruchen und deiner Flotte beizutreten.</p>
      ...
      <p style={{ color: "var(--dim)", fontSize: "0.8rem" }}>Öffentliche Operationen kannst du auch ohne Login <Link to="/" style={{ color: "var(--cyan)" }}>ansehen</Link>.</p>
    </div>
  );
}
