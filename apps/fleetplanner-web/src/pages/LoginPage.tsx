...
const PROVIDERS: Array<{ key: string; labelKey: string; border: string; bg: string; color: string; icon: React.ReactNode }> = [
  ...
  {
    key: "github", labelKey: "login.github", border: "rgba(255,255,255,0.16)", bg: "rgba(255,255,255,0.04)", color: "#ccdde8",
  ...
  {
    key: "google", labelKey: "login.google", border: "rgba(255,255,255,0.16)", bg: "rgba(255,255,255,0.04)", color: "#ccdde8",
...
export function LoginPage() {
  ...
  return (
    <div data-testid="login-page" style={{ maxWidth: 420, margin: "3rem auto", textAlign: "center" }}>
      ...
      <p style={{ color: "#9fb1c2", fontSize: "0.9rem", margin: "0 0 1.6rem", lineHeight: 1.6 }}>{t("login.intro")}</p>
