...
.comp-row-head {
  display: grid;
  grid-template-columns: minmax(12rem, 1fr) minmax(5.5rem, 0.34fr) minmax(7rem, 0.48fr) minmax(6rem, 0.4fr);
  gap: 0.65rem;
  align-items: center;
}
.fleet-req-head {
...
.opv2-unit-summary::-webkit-details-marker {
  display: none;
}
.opv2-unit-summary::before {
  content: "+";
  position: absolute;
  left: 0;
  top: 0.1rem;
...
.opv2-unit-card[open] > .opv2-unit-summary::before {
  content: "-";
}
.opv2-unit-main {
  min-width: 0;
