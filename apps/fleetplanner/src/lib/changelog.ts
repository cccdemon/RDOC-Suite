...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      ...
      "Mission covers are fixed: everything except the 16:9 format used to export a piece of the editor instead of the cover. Square and portrait covers now render properly.",
      "On a cover, the badges no longer sit on the header line, the QR code no longer covers the footer, and the asset list keeps its line breaks.",
      "Covers say RDOC instead of the placeholder text the tool shipped with.",
